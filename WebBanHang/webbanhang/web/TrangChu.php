...
<div class="topbar header">
					...
					if(!empty($username))
					{
						 ...
						 foreach($query as $item)
						 {
							 if($item['username']=='admin')
							 {
								...
								<a style="color: white" href="Trangcanhan.php">Xin Chào - '.($item['Ten']).'</a>
	...
	<div class="container row main">
		<div class="col-lg-3 left-menu">
			<div class="list-group">
				...
				<?php
						...
						{
							echo'
								<a href="TrangChu.php?id='.$item['id_DanhMuc'].'" class="list-group-item " name="linkweb">'.($item['name_DanhMuc']).'</a>
							';
						}    
                ?>
			</div>
		...
		<div class="col-lg-9"> 
			<div id="demo" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="https://bom.to/aaWV49a7MMAtW6" alt="Los Angeles">
					</div>
					<div class="carousel-item">
						<img src="https://bom.to/TfCmk28fhewfZj" alt="Chicago">
					</div>
				</div>
			...
			<div class="col-lg-6">
                <img src="../imageSP/247.png" style="width: 100%;height:270px;margin-top:-19%;border-radius:20px">
			</div>
		</div>
		...
		<div class="container-fluid product">
            ...
            <?php
				if(isset($_POST['search']))
				{
					...
					$sql = 'select * FROM sanpham WHERE name_SP LIKE"'.$tukhoa.'%"';
				}
				if(isset($_GET['id']))
				{
					$id = $_GET['id'];
